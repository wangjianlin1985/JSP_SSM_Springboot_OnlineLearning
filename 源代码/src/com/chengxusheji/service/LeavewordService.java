...
public class LeavewordService {
    ...
    /*按照查询条件分页查询留言答疑记录*/
    public ArrayList<Leaveword> queryLeaveword(String leaveTitle,Student userObj,String leaveTime,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Leaveword> queryLeaveword(String leaveTitle,Student userObj,String leaveTime) throws Exception  { 
     	String where = "where 1=1";
    	if(!leaveTitle.equals("")) where = where + " and t_leaveword.leaveTitle like '%" + leaveTitle + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_leaveword.userObj='" + userObj.getUser_name() + "'";
    	if(!leaveTime.equals("")) where = where + " and t_leaveword.leaveTime like '%" + leaveTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String leaveTitle,Student userObj,String leaveTime) throws Exception {
     	String where = "where 1=1";
    	if(!leaveTitle.equals("")) where = where + " and t_leaveword.leaveTitle like '%" + leaveTitle + "%'";
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_leaveword.userObj='" + userObj.getUser_name() + "'";
    	if(!leaveTime.equals("")) where = where + " and t_leaveword.leaveTime like '%" + leaveTime + "%'";
