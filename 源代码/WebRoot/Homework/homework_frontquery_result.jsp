				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>作业课程</td><td>作业任务</td><td>作业文件</td><td>作业日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="homeworkQueryForm" id="homeworkQueryForm" action="<%=basePath %>Homework/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="courseObj_courseNo">作业课程：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="homework_courseObj_courseNo_edit" class="col-md-3 text-right">作业课程:</label>
		  	 <div class="col-md-9">
