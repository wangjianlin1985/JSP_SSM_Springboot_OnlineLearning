...
<%
    ...
    String leaveTitle = (String)request.getAttribute("leaveTitle"); //留言问题查询关键字
    Student userObj = (Student)request.getAttribute("userObj");
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Leaveword/leaveword_frontAdd.jsp" style="display:none;">添加留言答疑</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言问题</td><td>留言人</td><td>留言时间</td><td>答疑回复</td><td>答疑时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<leavewordList.size();i++) {
					    	            		...
					    	            		Leaveword leaveword = leavewordList.get(i); //获取到留言答疑对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="leavewordQueryForm" id="leavewordQueryForm" action="<%=basePath %>Leaveword/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				...
				<input type="text" id="leaveTitle" name="leaveTitle" value="<%=leaveTitle %>" class="form-control" placeholder="请输入留言问题">
			</div>
                ...
                <select id="userObj_user_name" name="userObj.user_name" class="form-control">
                	<option value="">不限制</option>
	 				...
	 				for(Student studentTemp:studentList) {
	 					String selected = "";
 					if(userObj!=null && userObj.getUser_name()!=null && userObj.getUser_name().equals(studentTemp.getUser_name()))
 						selected = "selected";
	 				%>
