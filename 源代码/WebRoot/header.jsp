...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">在线学习网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Xiti/frontlist">习题练习测试</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">留言答疑</a></li>
                <li><a href="<%=basePath %>Video/frontlist">视频学习</a></li>
                <li><a href="<%=basePath %>Kejian/frontlist">课件下载</a></li>
                <li><a href="<%=basePath %>Homework/frontlist">家庭作业</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Leaveword/leaveword_studentFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要提问</a></li>
                        <li><a href="<%=basePath %>Leaveword/studentFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的问题</a></li>
