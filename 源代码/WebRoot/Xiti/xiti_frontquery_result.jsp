...
<%
    ...
    String xitiTime = (String)request.getAttribute("xitiTime"); //添加时间查询关键字
%>
<!DOCTYPE html>
<html>
<head>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>习题id</td><td>所属课程</td><td>习题标题</td><td>添加时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=xiti.getCourseObj().getCourseName() %></td>
 											<td><%=xiti.getTitle() %></td>
 											<td><%=xiti.getXitiTime() %></td>
 											<td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="xitiQueryForm" id="xitiQueryForm" action="<%=basePath %>Xiti/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="courseObj_courseNo">所属课程：</label>
			...
			<div class="form-group">
				<label for="xitiTime">添加时间:</label>
				<input type="text" id="xitiTime" name="xitiTime" class="form-control"  placeholder="请选择添加时间" value="<%=xitiTime %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="xiti_courseObj_courseNo_edit" class="col-md-3 text-right">所属课程:</label>
		  	 <div class="col-md-9">
			    <select id="xiti_courseObj_courseNo_edit" name="xiti.courseObj.courseNo" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="xiti_xitiTime_edit" class="col-md-3 text-right">添加时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date xiti_xitiTime_edit col-md-12" data-link-field="xiti_xitiTime_edit">
                    <input class="form-control" id="xiti_xitiTime_edit" name="xiti.xitiTime" size="16" type="text" value="" placeholder="请选择添加时间" readonly>
...
$(function(){
    ...
    /*添加时间组件*/
    $('.xiti_xitiTime_edit').datetimepicker({
    	language:  'zh-CN',  //语言
