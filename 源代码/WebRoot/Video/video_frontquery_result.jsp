		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Video/video_frontAdd.jsp" style="display:none;">添加视频录像</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>视频标题</td><td>所属课程</td><td>视频文件</td><td>录制时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<videoList.size();i++) {
					    	            		...
					    	            		Video video = videoList.get(i); //获取到视频录像对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
